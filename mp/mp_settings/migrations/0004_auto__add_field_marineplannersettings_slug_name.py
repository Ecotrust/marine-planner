...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MarinePlannerSettings.slug_name'
        db.add_column('mp_settings_marineplannersettings', 'slug_name',
                      self.gf('django.db.models.fields.CharField')(max_length=75, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MarinePlannerSettings.slug_name'
        db.delete_column('mp_settings_marineplannersettings', 'slug_name')
