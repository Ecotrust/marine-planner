...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MarinePlannerSettings.enable_drawing'
        db.add_column(u'mp_settings_marineplannersettings', 'enable_drawing',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MarinePlannerSettings.enable_drawing'
        db.delete_column(u'mp_settings_marineplannersettings', 'enable_drawing')
    ...
    models = {
        ...
        u'mp_settings.marineplannersettings': {
            ...
            'table_of_contents': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['data_manager.TOC']", 'null': 'True', 'blank': 'True'}),
