...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MarinePlannerSettings.default_hash'
        db.add_column(u'mp_settings_marineplannersettings', 'default_hash',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MarinePlannerSettings.default_hash'
        db.delete_column(u'mp_settings_marineplannersettings', 'default_hash')
