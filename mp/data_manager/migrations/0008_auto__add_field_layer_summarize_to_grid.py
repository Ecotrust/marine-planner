...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Layer.summarize_to_grid'
        db.add_column('data_manager_layer', 'summarize_to_grid',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Layer.summarize_to_grid'
        db.delete_column('data_manager_layer', 'summarize_to_grid')
