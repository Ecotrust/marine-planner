...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Layer.slug_name'
        db.alter_column('data_manager_layer', 'slug_name', self.gf('django.db.models.fields.CharField')(max_length=244, null=True))

        # Changing field 'Layer.name'
        db.alter_column('data_manager_layer', 'name', self.gf('django.db.models.fields.CharField')(max_length=244))

    def backwards(self, orm):

        # Changing field 'Layer.slug_name'
        db.alter_column('data_manager_layer', 'slug_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Layer.name'
        db.alter_column('data_manager_layer', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))
