...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TOCTheme'
        db.create_table('data_manager_toctheme', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('display_name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('data_manager', ['TOCTheme'])

        # Adding M2M table for field layers on 'TOCTheme'
        m2m_table_name = db.shorten_name('data_manager_toctheme_layers')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('toctheme', models.ForeignKey(orm['data_manager.toctheme'], null=False)),
            ('layer', models.ForeignKey(orm['data_manager.layer'], null=False))
        ))
        db.create_unique(m2m_table_name, ['toctheme_id', 'layer_id'])


    def backwards(self, orm):
        # Deleting model 'TOCTheme'
        db.delete_table('data_manager_toctheme')

        # Removing M2M table for field layers on 'TOCTheme'
        db.delete_table(db.shorten_name('data_manager_toctheme_layers'))
