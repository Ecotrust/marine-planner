...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TOC'
        db.create_table('data_manager_toc', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('data_manager', ['TOC'])

        # Adding M2M table for field themes on 'TOC'
        m2m_table_name = db.shorten_name('data_manager_toc_themes')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('toc', models.ForeignKey(orm['data_manager.toc'], null=False)),
    ...
    def backwards(self, orm):
        # Deleting model 'TOC'
        db.delete_table('data_manager_toc')

        # Removing M2M table for field themes on 'TOC'
        db.delete_table(db.shorten_name('data_manager_toc_themes'))
