...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GridCell.inlet_distance'
        db.alter_column(u'scenarios_gridcell', 'inlet_distance', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'GridCell.pier_distance'
        db.alter_column(u'scenarios_gridcell', 'pier_distance', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'GridCell.outfall_distance'
        db.alter_column(u'scenarios_gridcell', 'outfall_distance', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'GridCell.shore_distance'
        db.alter_column(u'scenarios_gridcell', 'shore_distance', self.gf('django.db.models.fields.FloatField')(null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'GridCell.inlet_distance'
        db.alter_column(u'scenarios_gridcell', 'inlet_distance', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'GridCell.pier_distance'
        db.alter_column(u'scenarios_gridcell', 'pier_distance', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'GridCell.outfall_distance'
        db.alter_column(u'scenarios_gridcell', 'outfall_distance', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'GridCell.shore_distance'
        db.alter_column(u'scenarios_gridcell', 'shore_distance', self.gf('django.db.models.fields.IntegerField')(null=True))
