...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'GridCell.prev_impact'
        db.delete_column(u'scenarios_gridcell', 'prev_impact')


    def backwards(self, orm):
        # Adding field 'GridCell.prev_impact'
        db.add_column(u'scenarios_gridcell', 'prev_impact',
