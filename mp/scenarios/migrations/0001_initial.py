...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'scenarios_scenario', (
            ...
            ('habitat', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('modifier', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('type_1', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('type_2', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('fish_abundance', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ...
            ('coral_size', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('inlet_distance', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('shore_distance', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('prev_impact', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
