...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Scenario.fish_abundance_min'
        db.delete_column(u'scenarios_scenario', 'fish_abundance_min')

        # Deleting field 'Scenario.fish_abundance_max'
        db.delete_column(u'scenarios_scenario', 'fish_abundance_max')

        # Deleting field 'Scenario.fish_abundance'
        db.delete_column(u'scenarios_scenario', 'fish_abundance')


    def backwards(self, orm):
        # Adding field 'Scenario.fish_abundance_min'
        db.add_column(u'scenarios_scenario', 'fish_abundance_min',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Scenario.fish_abundance_max'
        db.add_column(u'scenarios_scenario', 'fish_abundance_max',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Scenario.fish_abundance'
        db.add_column(u'scenarios_scenario', 'fish_abundance',
