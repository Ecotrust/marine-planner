...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Scenario.min_depth'
        db.delete_column(u'scenarios_scenario', 'min_depth')

        # Deleting field 'Scenario.mean_depth'
        db.delete_column(u'scenarios_scenario', 'mean_depth')

        # Deleting field 'Scenario.max_depth'
        db.delete_column(u'scenarios_scenario', 'max_depth')
    ...
    def backwards(self, orm):
        # Adding field 'Scenario.min_depth'
        db.add_column(u'scenarios_scenario', 'min_depth',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Scenario.mean_depth'
        db.add_column(u'scenarios_scenario', 'mean_depth',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Scenario.max_depth'
        db.add_column(u'scenarios_scenario', 'max_depth',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)
