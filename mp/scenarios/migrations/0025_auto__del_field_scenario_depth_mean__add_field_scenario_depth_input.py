...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Scenario.depth_input'
        db.add_column(u'scenarios_scenario', 'depth_input',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Scenario.depth_input'
        db.delete_column(u'scenarios_scenario', 'depth_input')
