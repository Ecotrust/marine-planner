...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'GridCell.fish_abundance'
        db.delete_column(u'scenarios_gridcell', 'fish_abundance')


    def backwards(self, orm):
        # Adding field 'GridCell.fish_abundance'
        db.add_column(u'scenarios_gridcell', 'fish_abundance',
