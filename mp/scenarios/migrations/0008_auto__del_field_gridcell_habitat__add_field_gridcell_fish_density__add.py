...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GridCell.coral_div'
        db.add_column(u'scenarios_gridcell', 'coral_div',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)
        ...
        # Adding field 'GridCell.dendro_pr'
        db.add_column(u'scenarios_gridcell', 'dendro_pr',
        ...
        # Adding field 'GridCell.rugosity'
        db.add_column(u'scenarios_gridcell', 'rugosity',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'GridCell.min_depth'
        db.add_column(u'scenarios_gridcell', 'min_depth',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'GridCell.max_depth'
        db.add_column(u'scenarios_gridcell', 'max_depth',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'GridCell.mean_depth'
        db.add_column(u'scenarios_gridcell', 'mean_depth',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)
        ...
        # Adding field 'GridCell.surface_area'
        db.add_column(u'scenarios_gridcell', 'surface_area',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'GridCell.coral_div'
        db.delete_column(u'scenarios_gridcell', 'coral_div')
        ...
        # Deleting field 'GridCell.dendro_pr'
        db.delete_column(u'scenarios_gridcell', 'dendro_pr')
        ...
        # Deleting field 'GridCell.rugosity'
        db.delete_column(u'scenarios_gridcell', 'rugosity')

        # Deleting field 'GridCell.min_depth'
        db.delete_column(u'scenarios_gridcell', 'min_depth')

        # Deleting field 'GridCell.max_depth'
        db.delete_column(u'scenarios_gridcell', 'max_depth')

        # Deleting field 'GridCell.mean_depth'
        db.delete_column(u'scenarios_gridcell', 'mean_depth')
        ...
        # Deleting field 'GridCell.surface_area'
        db.delete_column(u'scenarios_gridcell', 'surface_area')
    ...
    models = {
        ...
        u'scenarios.gridcell': {
            ...
            'mean_depth': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'min_depth': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
