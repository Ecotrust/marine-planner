...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'GridCell.modifier'
        db.delete_column(u'scenarios_gridcell', 'modifier')

        # Deleting field 'GridCell.type_2'
        db.delete_column(u'scenarios_gridcell', 'type_2')

        # Deleting field 'GridCell.type_1'
        db.delete_column(u'scenarios_gridcell', 'type_1')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'GridCell.modifier'
        db.add_column(u'scenarios_gridcell', 'modifier',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'GridCell.type_2'
        db.add_column(u'scenarios_gridcell', 'type_2',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'GridCell.type_1'
        db.add_column(u'scenarios_gridcell', 'type_1',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)
