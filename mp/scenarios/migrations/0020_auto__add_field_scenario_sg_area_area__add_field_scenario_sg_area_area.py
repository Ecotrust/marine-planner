...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Scenario.sg_area_area'
        db.add_column(u'scenarios_scenario', 'sg_area_area',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Scenario.sg_area_area_min'
        db.add_column(u'scenarios_scenario', 'sg_area_area_min',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Scenario.sg_area_area_max'
        db.add_column(u'scenarios_scenario', 'sg_area_area_max',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Scenario.sg_area_area'
        db.delete_column(u'scenarios_scenario', 'sg_area_area')

        # Deleting field 'Scenario.sg_area_area_min'
        db.delete_column(u'scenarios_scenario', 'sg_area_area_min')

        # Deleting field 'Scenario.sg_area_area_max'
        db.delete_column(u'scenarios_scenario', 'sg_area_area_max')
    ...
    models = {
        ...
        u'scenarios.scenario': {
            ...
            'sg_area_area': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'sg_area_area_max': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'sg_area_area_min': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
