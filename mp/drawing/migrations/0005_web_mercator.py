...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.execute(
            "SELECT UpdateGeometrySRID('drawing_aoi','geometry_final',3857);")
        db.execute(
            "SELECT UpdateGeometrySRID('drawing_aoi','geometry_orig',3857);")

    def backwards(self, orm):
        db.execute(
            "SELECT UpdateGeometrySRID('drawing_aoi','geometry_final',99996);")
        db.execute(
            "SELECT UpdateGeometrySRID('drawing_aoi','geometry_orig',99996);")
